...
#   An authorized --recover-missing path accepts only a missing or agent-free
#   Herdr endpoint, creates one replacement pane, and proves its shell is in
#   the recorded worktree before arming the new incarnation.
